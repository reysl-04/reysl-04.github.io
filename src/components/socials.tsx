                ...
                >
                    {social.name === "gmail" ? (
                        <button
                            ...
                            className="flex w-full h-full items-center justify-center rounded-xl bg-transparent p-1 transition-colors duration-500 ease-in-out delay-0 hover:bg-[#1A2336] cursor-pointer"
