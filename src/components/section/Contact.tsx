...
export default function Contact() {
    return (
        <section id="contact" className="w-full bg-[#D9E1F8] px-8 py-20 md:px-14 lg:px-24 md:py-24">
            <AnimatedSection className="mx-auto w-full max-w-4xl text-center" amount={0.18}>
                <AnimatedItem>
                    <h2 className="text-4xl font-bold tracking-widest mb-20 md:mb-24">Let&apos;s build something together!</h2>
                </AnimatedItem>

                <AnimatedItem className="mx-auto w-full max-w-3xl">
                    <div className="overflow-hidden rounded-2xl border border-[#3c3c3c] bg-[#1e1e1e] text-left shadow-sm">
                    ...
                    <pre className="overflow-x-auto p-4 text-sm leading-7 font-mono md:p-5">
                        <code>
<span className="text-[#858585]">1</span>{"  "}<span className="text-[#569cd6]">const</span>{" "}<span className="text-[#9cdcfe]">you</span><span className="text-[#858585]">{" ="}</span> <span className="text-[#dcdcaa]">window</span>.<span className="text-[#dcdcaa]">prompt</span><span className="text-[#858585]">{"("}</span><span className="text-[#ce9178]">"Type: hire me"</span><span className="text-[#858585]">{");"}</span>
{"\n"}
