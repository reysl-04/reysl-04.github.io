...
export default function Work() {
  ...
  return (
    <section className="w-full bg-[#0F1521] px-8 pt-6 pb-16 min-[960px]:w-screen min-[960px]:h-screen min-[960px]:pt-0 min-[960px]:pb-0 min-[960px]:flex min-[960px]:items-center min-[960px]:justify-center">
