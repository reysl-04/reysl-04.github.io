...
export default function Work() {
  ...
  return (
    <section id="experience" className="w-full bg-[#0F1521] px-8 pt-6 pb-16 min-[960px]:w-screen min-[960px]:h-screen min-[960px]:pt-0 min-[960px]:pb-0 min-[960px]:flex min-[960px]:items-center min-[960px]:justify-center">
      <div className="w-full max-w-6xl">
        <h2 className="text-[#EDF2FF]! text-center text-4xl font-bold tracking-widest mb-20 min-[960px]:mb-12 mt-12 sm:mt-12 md:mt-12 md:mb-20 lg:-mt-20">Experience & Projects</h2>
